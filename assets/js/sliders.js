...
document.addEventListener("DOMContentLoaded", () => {
  const sliderEl = document.querySelector(".js-post-slider");
  if (!sliderEl) return;

  const prevBtn = document.querySelector(".post-slider__prev");
  const nextBtn = document.querySelector(".post-slider__next");
